...
<form action="controller_reservation.php" id="form_reservation">
...
<div class="form-group">
    ...
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name="email" for="form_reservation">
</div>
